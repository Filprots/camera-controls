...
export interface CameraControlsEventMap {
	...
	transitionstart: { type: 'transitionstart', target: any };
	controlstart   : { type: 'controlstart', target: any };
	control        : { type: 'control', target: any };
	controlend     : { type: 'controlend', target: any };
}
